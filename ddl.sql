...
CREATE TABLE onlinestoredb.ORDER_STATUS
(
    STATUSID NUMBER,
    STATUS  VARCHAR2(100)
);
...
CREATE TABLE onlinestoredb.REGIONS_AUD
( 
...
CREATE TABLE onlinestoredb.COUNTRIES_AUD
(
...
CREATE TABLE onlinestoredb.LOCATIONS_AUD
(
...
CREATE TABLE onlinestoredb.WAREHOUSES_AUD
(
...
CREATE TABLE onlinestoredb.DEPARTMENT_AUD
(
...
CREATE TABLE onlinestoredb.EMPLOYEES_AUD
(
    EMPLOYEEID NUMBER,
...
CREATE TABLE onlinestoredb.PRODUCT_CATEGORY_AUD
(
...
CREATE TABLE onlinestoredb.PRODUCTS_AUD
(
    PRODUCTID NUMBER,
...
CREATE TABLE onlinestoredb.INVENTORY_AUD
(
    INVENTORYID NUMBER,
    PRODUCTID NUMBER,
    OLDQUANTITY NUMBER,
...
CREATE TABLE onlinestoredb.CUSTOMERS_AUD
(
    CUSTOMERID NUMBER,
...
CREATE TABLE onlinestoredb.CONTACTS_AUD
(
    CONTACTID NUMBER,
    OLDFIRSTNAME VARCHAR2(100),
	NEWFIRSTNAME VARCHAR2(100),
...
CREATE TABLE onlinestoredb.ORDER_STATUS_AUD
(
    STATUSID NUMBER,
...
CREATE TABLE onlinestoredb.ORDERS_AUD
(
    ORDERID NUMBER,
...
CREATE TABLE onlinestoredb.ORDER_ITEMS_AUD
(
    ORDERID NUMBER,
    ITEMID NUMBER,
    PRODUCTID  NUMBER,
